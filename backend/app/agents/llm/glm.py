"""GLM (智谱 AI) LLM provider implementation.

智谱 AI uses OpenAI-compatible API with custom base URL.
"""
...
class GLMLLM(BaseLLM):
    ...
    智谱 AI provides OpenAI-compatible API endpoints.
    Model examples: glm-4, glm-4-flash, glm-3-turbo, etc.
    """
    ...
    def _get_client(self) -> AsyncOpenAI:
        ...
        if self._client is None:
            base_url = self.config.base_url or GLM_DEFAULT_BASE_URL
    ...
    async def count_tokens(self, text: str) -> int:
        ...
        # GLM models are optimized for Chinese
